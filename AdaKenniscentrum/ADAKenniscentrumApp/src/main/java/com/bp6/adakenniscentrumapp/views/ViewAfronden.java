...
public class ViewAfronden {
    ...
    public ViewAfronden(int i){
        ...
        // Switch case voor de verschillende type afrondschermen. De onderstaande nummers worden doorgegeven bij het aanroepen van dit scherm
        // om te zorgen dat de juiste teksten worden getoond
        // 1 = boek toevoegen
