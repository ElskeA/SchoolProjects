...
public class TouringScreen {

    public TouringScreen(VController vc){
        ...
        Label lbPass = new Label("Aantal passagiers: ");
        ...
        btnOpslaan.setOnAction(e->{
            int aantal = Integer.parseInt(txtPass.getText());
            if(aantal >= 6){
            try{
                Touringcar a = new Touringcar(dp.getValue().toString(),
                        txtTijd.getText(),
                        txtSp.getText(),
                        txtEb.getText(),
                        txtBjaar.getText(),
                        ...
                        Integer.parseInt(txtPass.getText()));
                vc.opslaanV(a);
        ...
        {
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setContentText("Let op: Minimaal aantal passagiers is 6");
            alert.showAndWait();
        }});
