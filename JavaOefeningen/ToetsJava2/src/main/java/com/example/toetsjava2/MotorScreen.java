...
public class MotorScreen {

    public MotorScreen(VController vc){
        ...
        Label lbZijspan = new Label("Zijspan");
        String[] spanString = {"Ja", "Nee"};
        ComboBox cbSpan = new ComboBox(FXCollections.observableArrayList(spanString));
