        ...
        btnVolgende.setOnAction(e->{
            if (rbArduino.isSelected()){
                ...
                if (tfItem.getText().isBlank()){
                    ...
                    // Het ingevulde ID nummer wordt meegenomen in de controller
                    ArduinoController ac = new ArduinoController(id);
                    // Vervolgens wordt de gebruiker direct doorverwezen naar het correcte afrondscherm door het nummer wat wordt meegegeven
